...
<div id="archives" class="post">
  <div class="archive-group">
    ...
    <!-- Capture the category name for Miscellaneous writeups -->
    {% capture category_name %}Miscellaneous writeups{% endcapture %}
    ...
    <!-- Loop through posts in the Miscellaneous writeups category -->
